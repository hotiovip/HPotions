...
public class HPotions implements ModInitializer {
    ...
    public static final Holder<@NotNull MobEffect> ENDER_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "ender_eye"), new EnderEffect());
    public static final Holder<@NotNull Potion> ENDER_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "ender_eye"),
    ...
    public static final Holder<@NotNull MobEffect> COPPER_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "copper_eye"), new CopperEffect());
    public static final Holder<@NotNull Potion> COPPER_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "copper_eye"),
    ...
    public static final Holder<@NotNull MobEffect> IRON_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "iron_eye"), new IronEffect());
    public static final Holder<@NotNull Potion> IRON_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "iron_eye"),
    ...
    public static final Holder<@NotNull MobEffect> GOLD_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "gold_eye"), new GoldEffect());
    public static final Holder<@NotNull Potion> GOLD_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "gold_eye"),
    ...
    public static final Holder<@NotNull MobEffect> LAPIS_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "lapis_eye"), new LapisEffect());
    public static final Holder<@NotNull Potion> LAPIS_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "lapis_eye"),
    ...
    public static final Holder<@NotNull MobEffect> REDSTONE_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "redstone_eye"), new RedstoneEffect());
    public static final Holder<@NotNull Potion> REDSTONE_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "redstone_eye"),
    ...
    public static final Holder<@NotNull MobEffect> DIAMOND_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "diamond_eye"), new DiamondEffect());
    public static final Holder<@NotNull Potion> DIAMOND_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "diamond_eye"),
    ...
    public static final Holder<@NotNull MobEffect> EMERALD_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "emerald_eye"), new EmeraldEffect());
    public static final Holder<@NotNull Potion> EMERALD_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "emerald_eye"),
    ...
    public static final Holder<@NotNull MobEffect> ANCIENT_DEBRIS_EFFECT =
            Registry.registerForHolder(BuiltInRegistries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "ancient_debris_eye"), new AncientDebrisEffect());
    public static final Holder<@NotNull Potion> ANCIENT_DEBRIS_POTION =
            Registry.registerForHolder(
                    BuiltInRegistries.POTION,
                    ResourceLocation.fromNamespaceAndPath(HPotions.MOD_ID, "ancient_debris_eye"),
